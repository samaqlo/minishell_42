...
#    Updated: 2023/06/22 04:57:09 by astalha          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = libft/ft_isalnum.c libft/ft_isprint.c libft/ft_memcmp.c libft/ft_strlcat.c libft/ft_strncmp.c  libft/ft_isalpha.c libft/ft_strnstr.c libft/ft_calloc.c libft/ft_strtrim.c libft/ft_strmapi.c libft/ft_striteri.c libft/ft_putendl_fd.c\
		...
		minishell.c lexer.c linkedlist.c ft_substr_parse.c cleaner.c ./built/execution.c error_centre.c linkedlist_p_to_e.c the_expander.c built/utils.c  built/builtin.c built/builtin_rest.c built/built_src.c built/built_src2.c ft_strcmp.c \
