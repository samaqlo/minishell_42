...
*A mini recreation of bash.  Implementing previously learned concepts like file descriptors and processes.  Made in collaboration with my peer [Otmane Haimad](https://github.com/ohaimad).*
